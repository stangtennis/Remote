...
- [!] Hvis `REDACTED_TURN_SECRET` har været brugt i produktion, skal den TURN secret roteres, fordi den ligger i git-historikken.
...
- [x] Byg controller/agent `v3.1.116`; spejl decoded H.264 video til canvas og log H.264 visual checksum/change-count for at omgå WebView video-paint problemer.
- [x] `WIN-TEST` retestet med `v3.1.116`; H.264 viser nu løbende skærmopdateringer og input virker.
