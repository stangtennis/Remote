...
→ RemoteDesktopAgent-v3.1.91-Setup.exe
```

**Flow:**
1. Download og kør `RemoteDesktopAgent-v3.1.91-Setup.exe`
...
```
https://github.com/stangtennis/Remote/releases/latest
→ RemoteDesktopController-v3.1.91-Setup.exe
```

**Flow:**
1. Download og kør `RemoteDesktopController-v3.1.91-Setup.exe`
...
4. Medarbejder downloader: RemoteDesktopAgent-v3.1.91-Setup.exe
...
**Seneste version:** v3.1.91

**Tilgængelige downloads:**
- `remote-agent-v3.1.91.exe` - Native Windows agent (GUI)
- `remote-agent-console-v3.1.91.exe` - Console version (headless)
- `controller-v3.1.91.exe` - Native Windows controller
- `RemoteDesktopAgent-v3.1.91-Setup.exe` - Agent installer
- `RemoteDesktopController-v3.1.91-Setup.exe` - Controller installer
