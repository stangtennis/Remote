...
→ RemoteDesktopAgent-v3.1.82-Setup.exe
```

**Flow:**
1. Download og kør `RemoteDesktopAgent-v3.1.82-Setup.exe`
...
```
https://github.com/stangtennis/Remote/releases/latest
→ RemoteDesktopController-v3.1.82-Setup.exe
```

**Flow:**
1. Download og kør `RemoteDesktopController-v3.1.82-Setup.exe`
...
4. Medarbejder downloader: RemoteDesktopAgent-v3.1.82-Setup.exe
...
**Seneste version:** v3.1.82

**Tilgængelige downloads:**
- `remote-agent-v3.1.82.exe` - Native Windows agent (GUI)
- `remote-agent-console-v3.1.82.exe` - Console version (headless)
- `controller-v3.1.82.exe` - Native Windows controller
- `RemoteDesktopAgent-v3.1.82-Setup.exe` - Agent installer
- `RemoteDesktopController-v3.1.82-Setup.exe` - Controller installer
