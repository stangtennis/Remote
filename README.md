...
**Current version: v3.1.120** | [Download](https://github.com/stangtennis/Remote/releases/latest) | [Dashboard](https://dashboard.hawkeye123.dk)
...
- `RemoteDesktopAgent-v3.1.120-Setup.exe` — Windows agent (GUI + console + OpenH264 + TurboJPEG)
- `RemoteDesktopController-v3.1.120-Setup.exe` — Windows controller
...
**Prerequisites:** Go 1.24+, MinGW cross-compiler (`x86_64-w64-mingw32-gcc`)

```bash
# Full build (all platforms + installers)
./build-local.sh v3.1.120
