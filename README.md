...
**Current version: v3.1.92** | [Download](https://github.com/stangtennis/Remote/releases/latest) | [Dashboard](https://dashboard.hawkeye123.dk)
...
- `RemoteDesktopAgent-v3.1.92-Setup.exe` — Windows agent (GUI + console + OpenH264 + TurboJPEG)
- `RemoteDesktopController-v3.1.92-Setup.exe` — Windows controller
